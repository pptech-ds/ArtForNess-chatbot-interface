...
function setUserResponse(val) {
	var UserResponse = '<img class="userAvatar" src=' + "http://127.0.0.1/wordpress/wp-content/uploads/2020/11/userAvatar.jpg" + '><p class="userMsg">' + val + ' </p><div class="clearfix"></div>';
...
function setBotResponse(val) {
	setTimeout(function () {
		if (val.length < 1) {
			...
			var BotResponse = '<img class="botAvatar" src="http://127.0.0.1/wordpress/wp-content/uploads/2020/11/botAvatar.png"><p class="botMsg">' + msg + '</p><div class="clearfix"></div>';
				...
				if (val[i].hasOwnProperty("text")) {
					...
					if(i>0){
						...
						for (j = 0; j < CurrentRasaResponse.length; j++) {
							...
							if(j==0){
								var BotResponse = '<img class="botAvatar" src="http://127.0.0.1/wordpress/wp-content/uploads/2020/11/botAvatar.png">' + CurrentRasaResponse[j] + '</p><div class="clearfix"></div>';
								$(BotResponse).appendTo('.chats').hide().fadeIn(1000);
							}
							else {
						...
						var BotResponse = '<img class="botAvatar" src="http://127.0.0.1/wordpress/wp-content/uploads/2020/11/botAvatar.png">' + CurrentRasaResponse + '</p><div class="clearfix"></div>';
						$(BotResponse).appendTo('.chats').hide().fadeIn(1000);
					}
